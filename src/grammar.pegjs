...
Start
  = &{ skipBold = false; skipItalic = false; skipStrikethrough = false; skipReferences = false; skipBoldEmoji = false; skipItalicEmoji = false; skipInlineEmoji = false; return true; }
  @BigEmoji !.
...
Italic
  ...
  / [\x5F] [\x5F] c:ItalicContent [\x5F] [\x5F] { return c; }
  / [\x5F] c:ItalicContent [\x5F] { return c; }
